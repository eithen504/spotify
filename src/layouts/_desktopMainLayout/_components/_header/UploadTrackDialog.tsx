...
import { GENRES, MAX_AUDIO_DURATION } from "../../../../Constants";
...
const UploadTrackDialog: React.FC<UploadTrackDialogProps> = ({ isOpen, onClose }) => {
    ...
    const [isAudioDurationExceeded, setIsAudioDurationExceeded] = useState(false);
                ...
                <DialogHeader>
                    <div className="flex justify-between">
                        <div className="space-y-1">
                            ...
                            <DialogDescription className="text-white">Add a new song to your app</DialogDescription>
                        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 py-4">
                        ...
                        onChange={(e) => {
                            ...
                            if (file) {
                                ...
                                audio.onloadedmetadata = () => {
                                    ...
                                    setIsAudioDurationExceeded(durationInSeconds > MAX_AUDIO_DURATION)
                                    const formattedDuration = formatDuration(durationInSeconds);
                                    setTrackData({ ...trackData, duration: formattedDuration })
                                };
                            }
                        }}
                    />
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={(e) => setTrackData({ ...trackData, albumId: e.target.value })}
                            type="text"
                            className="w-full bg-[#3e3e3e] font-semibold text-white px-3 py-2 rounded outline-none focus:outline-none focus:ring-0 focus:border-transparent"
                        />
                    </div>
