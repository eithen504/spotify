...
import { AddIcon, CrossIcon, ExpandIcon, MinimizeIcon, NextIcon, PlayIcon, PrevIcon, RepeatIcon, ShareIcon, ShuffleIcon, HighVolumeIcon } from "../../../../Svgs";
...
const MiniPlayerWindow: React.FC<MiniPlayerWindowProps> = ({ onClose }) => {
            ...
            <div className="flex flex-col" style={{ height: 'calc(100% - 48px)' }}>
                ...
                >
                    <div className="flex flex-col items-start space-y-0.5 z-10">
                        <span className="text-white text-lg font-bold">Perfect</span>
